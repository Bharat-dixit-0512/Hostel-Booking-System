...
import { getBookingWindow, releaseExpiredPendingBookings } from "../utils/booking.utils.js";
...
export const getEligibleHostels = asyncHandler(async (req, res) => {
    ...
    const summaryMap = new Map(roomSummaries.map((summary) => [summary._id, summary]));
